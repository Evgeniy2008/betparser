/**
 * Parik24 Live WebSocket Worker – Basketball
 *
 * Subscribes to live basketball events from Parik24 and writes to data/parik24_basketball_raw.json
 * Run: node tools/parik24_basketball_live_worker.js
 */
...
function parseMarketTuple(mkt) {
  ...
  // Basketball uses moneyline (type 3 or 1) – accept any type with home/away outcomes
...
function flushFile() {
  ...
  try {
    ...
    pushOutputRemote('parik24_basketball', output);
  } catch (err) {
